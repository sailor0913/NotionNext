...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Sailor', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '人生苦短， 我用Python', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://python.sailor.icu', // 网站地址
